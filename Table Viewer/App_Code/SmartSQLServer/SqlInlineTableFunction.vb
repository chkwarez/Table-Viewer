Namespace Smart
    Public Class SqlInlineTableFunction : Inherits SqlDatabaseObject : Implements IExecutable

#Region "Must Inherit Implementation"
        Public Overrides ReadOnly Property ObjectType() As String
            Get
                Return CommonProperty.GetObjectTypeCode(CommonProperty.DatabaseObject.InlineTableFunction)
            End Get
        End Property

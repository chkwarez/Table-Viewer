Namespace Smart
    Public Class SqlScalarValuedFunction : Inherits SqlDatabaseObject : Implements IExecutable

#Region "Must Inherit Implementation"
        Public Overrides ReadOnly Property ObjectType() As String
            Get
                Return CommonProperty.GetObjectTypeCode(CommonProperty.DatabaseObject.ScalarValuedFunction)
            End Get
        End Property
        ...
        Public Function GetExecutionScript(ByVal para As ParameterCollection) As String Implements IExecutable.GetExecutionScript
            ...
            For n = 0 To paraArray.Length - 1 'Create Parameter
                tmp = para.GetValue(paraArray(n), Nothing) 'If para contians such value, return that value, otherwise, return nothing
